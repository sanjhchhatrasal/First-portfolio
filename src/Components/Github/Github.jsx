...
function Github() {
  ...
  return (
    <div className='h-[80vh] w-full bg-slate-100 lg:py-[3vw] sm:py-[5vw] py-[5vw]'>
            <h1 className='lg:text-[2.5vw] sm:text-[3vw] text-[4vw] text-center pt-10 font-semibold text-orange-700 flex items-center justify-center'><FaGithub className='text-black mr-[1vw]'/> GitHub <span className='text-black'>Account</span></h1>
