...
function Header() {
  ...
  return (
    <div className=' h-fit w-full bg-slate-100 px-[5vw] sm:py-[2vw] flex items-center justify-between sticky top-0'>
      ...
      <div className={`${menuOpen ? "mt-[-29vw]" : "mt-0"} menu flex flex-col justify-between w-[2.25rem] h-2rem sm:hidden ml-[75vw] absolute sm:mt-0 mt-[0vw]`} onClick={() => {setMenuOpen(!menuOpen)}}>
        <span className='h-[0.3rem] w-[100%] bg-zinc-800 rounded-xl my-[0.15vw]'></span>
        <span className='h-[0.3rem] w-[100%] bg-zinc-800 rounded-xl my-[0.15vw]'></span>
        <span className='h-[0.3rem] w-[100%] bg-zinc-800 rounded-xl my-[0.15vw]'></span>
      </div>
